...
# Legal Stuff:
#
# This file is part of the Yarudave Icon Theme and is free software; you can redistribute it and/or modify it under
# the terms of the GNU Lesser General Public License as published by the Free Software
# Foundation; version 3.
#
# This file is part of the Yarudave Icon Theme and is distributed in the hope that it will be useful, but WITHOUT
...
for source in SOURCES:
    ...
    DEST = os.path.abspath(os.path.join(dest_path, "Yarudave" if args.variant ==
                                        'default' else "Yarudave-" + args.variant))
